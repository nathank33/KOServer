...
if (EVENT == 195) then
	SelectMsg(UID, 2, 235, 1233, NPC, 28, 196);
end
...
if (EVENT == 200) then -- Level 50 Lich
	SelectMsg(UID, 2, 235, 1014, NPC, 10, 201);
end

if (EVENT == 201) then
	SelectMsg(UID, 4, 235, 1015, NPC, 22, 202, 23, 193);
end
...
if (EVENT == 205) then
	SaveEvent(UID, 138);
	SelectMsg(UID, 2, 235, 1016, NPC, 21, 193);
end

if (EVENT == 210) then
	ITEM_COUNT = HowmuchItem(UID, 910090000);
	if (ITEM_COUNT < 3) then
		SelectMsg(UID, 2, 235, 1017, NPC, 18, 213);
	else
		SelectMsg(UID, 4, 235, 1018, NPC, 41, 214, 27, 193);
	end
end
...
if (EVENT == 334) then -- 61 Level Absolute Power Scroll
	SelectMsg(UID, 2, 308, 374, NPC, 28, 335);
end
...
if (EVENT == 337) then
	SelectMsg(UID, 4, 308, 376, NPC, 22, 338, 23, 193);
end
...
if (EVENT == 339) then
	SaveEvent(UID, 558);
	SelectMsg(UID, 2, 308, 378, NPC, 21, 193);
end
...
if (EVENT == 341) then
	...
	if (ITEM_COUNT1 < 7) then
		...
		SelectMsg(UID, 4, 308, 380, NPC, 41, 346, 27, 193);
	end
end
...
if (EVENT == 347) then -- Nostrum of Magic
	SelectMsg(UID, 2, 528, 385, NPC, 28, 348);
end
...
if (EVENT == 349) then
	SelectMsg(UID, 2, 528, 386, NPC, 10, 350);
end

if (EVENT == 350) then
	SelectMsg(UID, 4, 528, 387, NPC, 22, 351, 23, 193);
end
...
if (EVENT == 352) then
	SaveEvent(UID, 564);
	SelectMsg(UID, 2, 528, 389, NPC, 21, 193);
end
...
if (EVENT == 354) then
	...
	if (ITEM_COUNT1 < 1) then
		SelectMsg(UID, 2, 528, 390, NPC, 18, 355);
	end
	if (ITEM_COUNT2 < 1) then
		SelectMsg(UID, 2, 528, 390, NPC, 18, 356);
	end
	if (ITEM_COUNT3 < 2) then
		SelectMsg(UID, 2, 528, 390, NPC, 18, 357);
	end
	if (ITEM_COUNT1 > 0 and ITEM_COUNT2 > 0 and ITEM_COUNT3 > 1) then
		SelectMsg(UID, 4, 528, 393, NPC, 41, 358, 27, 193);
	end
end
...
if (EVENT == 371) then -- 53 Level Magic Jewel Powder
	SelectMsg(UID, 2, 235, 1240, NPC, 28, 372);
end
...
if (EVENT == 374) then
	SelectMsg(UID, 4, 235, 512, NPC, 22, 375, 23, 193);
end
...
if (EVENT == 376) then
	SaveEvent(UID, 576);
	SelectMsg(UID, 2, 235, 514, NPC, 21, 193);
end
...
if (EVENT == 378) then
	...
	if (ITEM_COUNT1 > 2 and ITEM_COUNT2 > 2 and ITEM_COUNT3 > 2) then
		SelectMsg(UID, 4, 235, 518, NPC, 41, 382, 27, 193);
	end   
end
...
if (EVENT == 383) then -- 53 Level Spell of Thorn
	SelectMsg(UID, 2, 325, 520, NPC, 28, 384);
end
...
if (EVENT == 385) then
	SelectMsg(UID, 2, 325, 521, NPC, 10, 386);
end

if (EVENT == 386) then
	SelectMsg(UID, 2, 325, 522, NPC, 22, 387, 23, 193);
end
...
if (EVENT == 388) then
	SaveEvent(UID, 582);
	SelectMsg(UID, 2, 325, 524, NPC, 21, 193);
end
...
if (EVENT == 390) then
	...
	if (ITEM_COUNT1 < 1000000) then
		SelectMsg(UID, 2, 325, 525, NPC, 18, 393);
	end
	if (ITEM_COUNT2 < 3) then
		SelectMsg(UID, 2, 325, 526, NPC, 18, 392);
	end
	if (ITEM_COUNT1 > 999999 and ITEM_COUNT2 > 2) then
		SelectMsg(UID, 2, 325, 528, NPC, 41, 394, 27, 193);
	end
end
...
if (EVENT == 500) then -- 56 Level Spell of İmpact
	SelectMsg(UID, 2, 217, 530, NPC, 28, 501);
end
...
if (EVENT == 502) then
	SelectMsg(UID, 2, 217, 531, NPC, 10, 503);
end

if (EVENT == 503) then
	SelectMsg(UID, 2, 217, 532, NPC, 22, 504, 23, 193);
end
...
if (EVENT == 505) then
	SaveEvent(UID, 588);
	SelectMsg(UID, 2, 217, 534, NPC, 21, 193);
end
...
if (EVENT == 507) then
	...
	if (ITEM_COUNT1 < 7) then
		SelectMsg(UID, 2, 217, 532, NPC, 18, 508);
	end
	if (ITEM_COUNT2 < 1500000) then
		SelectMsg(UID, 2, 217, 525, NPC, 18, 509);
	end
	if (ITEM_COUNT1 > 6 and ITEM_COUNT2 > 1499999) then
		SelectMsg(UID, 2, 217, 538, NPC, 41, 511, 27, 193);
	end
end
