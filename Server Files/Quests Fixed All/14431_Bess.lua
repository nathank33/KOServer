...
if (EVENT == 8257) then
	...
	if (MonsterCount < 40) then
		...
		SelectMsg(UID, 4, 219, 8268, NPC, 41, 8259, 27, 158);
	end
end
...
if (EVENT == 8357) then
	...
	if (MonsterCount < 40) then
		...
		SelectMsg(UID, 4, 224, 8268, NPC, 41, 8359, 27, 158);
	end
end
...
if (EVENT == 9187) then
	...
	if (MonsterCount < 40) then
		...
		SelectMsg(UID, 4, 238, 8268, NPC, 41, 9189, 27, 158);
	end
end
...
if (EVENT == 9020) then -- 55 Level Dragon Tooth Commander
	SelectMsg(UID, 2, 264, 8274, NPC, 14, 9021);
end
...
if (EVENT == 9022) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 264, 8446, NPC, 10, 9030);
	else
...
if (EVENT == 9030) then
	SelectMsg(UID, 4, 264, 8447, NPC, 22, 9023, 23, 9024);
end
...
if (EVENT == 9027) then
	...
	if (MonsterCount < 30) then
		SelectMsg(UID, 2, 264, 8267, NPC, 18, 9028);
	else
		SelectMsg(UID, 4, 264, 8451, NPC, 41, 9029, 27, 158);
	end
end
