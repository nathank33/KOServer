...
if (EVENT == 125) then
	MonsterCount = CountMonsterQuestSub(UID, 529, 1);
	if (MonsterCount < 200) then
...
if (EVENT == 135) then
	MonsterCount = CountMonsterQuestSub(UID, 530, 1);
...
if (EVENT == 145) then
	MonsterCount = CountMonsterQuestSub(UID, 533, 1);
...
if (EVENT == 175) then
	MonsterCount = CountMonsterQuestSub(UID, 551, 1);
	if (MonsterCount < 100) then
...
if (EVENT == 165) then
	MonsterCount = CountMonsterQuestSub(UID, 572, 1);
	if (MonsterCount < 200) then
