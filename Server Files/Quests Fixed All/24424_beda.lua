...
if (EVENT == 9542) then
	...
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1034, 8772, NPC, 22, 9543, 23, 9544);
	else
		SelectMsg(UID, 2, 1034, 8772, NPC, 10, 193);
	end
end
...
if (EVENT == 9547) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1034, 8772, NPC, 18, 9548);
	else
		SelectMsg(UID, 4, 1034, 8772, NPC, 41, 9549, 27, 9548);
	end
end
...
if (EVENT == 9372) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1017, 8686, NPC, 22, 9373, 23, 9374);
	else
		SelectMsg(UID, 2, 1017, 8686, NPC, 10, 193);
	end
end
...
if (EVENT == 9377) then
	MonsterCount = CountMonsterQuestSub(UID, 1017, 1);
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1017, 8686, NPC, 18, 9378);
	else
		SelectMsg(UID, 4, 1017, 8686, NPC, 41, 9379, 27, 9378);
	end
end
...
if (EVENT == 9382) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 343, 8688, NPC, 22, 9383, 23, 9384);
	else
		SelectMsg(UID, 2, 343, 8688, NPC, 10, 193);
	end
end
...
if (EVENT == 9387) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 343, 8688, NPC, 18, 9388);
	else
		SelectMsg(UID, 4, 343, 8688, NPC, 41, 9389, 27, 9388);
	end
end
...
if (EVENT == 9392) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1019, 8690, NPC, 22, 9393, 23, 9394);
	else
		SelectMsg(UID, 2, 1019, 8690, NPC, 10, 193);
	end
end
...
if (EVENT == 9397) then
	MonsterCount = CountMonsterQuestSub(UID, 1019, 1);
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1019, 8690, NPC, 18, 9398);
	else
		SelectMsg(UID, 4, 1019, 8690, NPC, 41, 9399, 27, 9398);
	end
end
...
if (EVENT == 9412) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 345, 8694, NPC, 22, 9413, 23, 9414);
	else
		SelectMsg(UID, 2, 345, 8694, NPC, 10, 193);
	end
end
...
if (EVENT == 9417) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 345, 8694, NPC, 18, 9418);
	else
		SelectMsg(UID, 4, 345, 8694, NPC, 41, 9419, 27, 9418);
	end
end
...
if (EVENT == 9422) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1022, 8696, NPC, 22, 9423, 23, 9424);
	else
		SelectMsg(UID, 2, 1022, 8696, NPC, 10, 193);
	end
end
...
if (EVENT == 9427) then
	MonsterCount = CountMonsterQuestSub(UID, 1022, 1);
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1022, 8696, NPC, 18, 9428);
	else
		SelectMsg(UID, 4, 1022, 8696, NPC, 41, 9429, 27, 9428);
	end
end
...
if (EVENT == 202) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1025, 1401, NPC, 22, 203, 23, 204);
	else
		SelectMsg(UID, 2, 1025, 1401, NPC, 10, 193);
	end
end
...
if (EVENT == 206) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1025, 1401, NPC, 18, 207);
	else
		SelectMsg(UID, 4, 1025, 1401, NPC, 41, 208, 27, 207);
	end
end
...
if (EVENT == 212) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 352, 1414, NPC, 22, 213, 23, 214);
	else
		SelectMsg(UID, 2, 352, 1414, NPC, 10, 193);
	end
end
...
if (EVENT == 216) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 352, 1414, NPC, 18, 217);
	else
		SelectMsg(UID, 4, 352, 1414, NPC, 41, 218, 27, 217);
	end
end
