...
if (EVENT == 200) then
	SelectMsg(UID, 4, 200, 1247, NPC, 22, 201, 23, 202);
end
...
if (EVENT == 205) then
	SelectMsg(UID, 2, 200, 1247, NPC, 10, 193);
	SaveEvent(UID, 124);
end
...
if (EVENT == 210) then
	...
	if (ItemA < 1) then
		...
		SelectMsg(UID, 4, 200, 1247, NPC, 41, 211, 27, 193);
	end
end
...
if (EVENT == 9532) then
	...
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 214, 8770, NPC, 22, 9533, 23, 9534);
	else
		SelectMsg(UID, 2, 214, 8770, NPC, 10, 193);
	end
end
...
if (EVENT == 9536) then
	...
	if (MonsterCount < 40) then
		...
		SelectMsg(UID, 4, 214, 8770, NPC, 41, 9538, 27, 193);
	end
end
