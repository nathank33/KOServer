...
if (EVENT == 1006) then
	CountMonster = CountMonsterQuestSub(UID, 143, 1);
...
if (EVENT == 9340) then -- 59 Level Manticore
	SelectMsg(UID, 2, 481, 8680, NPC, 10, 9341);
end
...
if (EVENT == 9342) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 481, 8680, NPC, 22, 9343, 23, 9344);
	else
		SelectMsg(UID, 2, 481, 8680, NPC, 10, 163);
	end
end
...
if (EVENT == 9347) then
	...
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 481, 8565, NPC, 18, 9348);
	else
		SelectMsg(UID, 4, 481, 8425, NPC, 41, 9349, 27, 163);
	end
end
