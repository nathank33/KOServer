...
if (EVENT == 195) then
	SelectMsg(UID, 2, 273, 3026, NPC, 10, 196);
end
...
if (EVENT == 197) then
	SelectMsg(UID, 2, 273, 3027, NPC, 28, 232);
end

if (EVENT == 200) then -- 55 Level Horn of Comprehension
	SelectMsg(UID, 2, 273, 3010, NPC, 10, 201);
end

if (EVENT == 201) then
	SelectMsg(UID, 4, 273, 3017, NPC, 22, 202, 23, 193);
end
...
if (EVENT == 205) then
	SaveEvent(UID, 3076);
	SelectMsg(UID, 2, 273, 3020, NPC, 3016, 193);
end

if (EVENT == 210) then
	ITEM_COUNT = HowmuchItem(UID, 900033000);
	if (ITEM_COUNT <= 0) then
		SelectMsg(UID, 2, 273, 3019, NPC, 10, 213);
	else
		SelectMsg(UID, 4, 273, 3022, NPC, 41, 214, 27, 193);
	end
end
...
if (EVENT == 220) then
	SelectMsg(UID, 2, 310, 3028, NPC, 3004, 1100, 3005, 1100);
end

if (EVENT == 1100) then
	SelectMsg(UID, 2, 310, 3029, NPC, 3006, 1101);
end

if (EVENT == 1101) then
	SelectMsg(UID, 2, 310, 3030, NPC, 3007, 221, 3008, 1102);
end
...
if (EVENT == 222) then
	SelectMsg(UID, 2, 310, 3032, NPC, 3003, 1110);
end

if (EVENT == 1110) then
	SelectMsg(UID, 2, 310, 3029, NPC, 3006, 1111);
end

if (EVENT == 1111) then
	SelectMsg(UID, 2, 310, 3030, NPC, 3007, 221, 3008, 1112);
end
...
if (EVENT == 223) then -- 61 Level Judgement Scroll
	SelectMsg(UID, 2, 310, 3036, NPC, 10, 227);
end

if (EVENT == 227) then
	SelectMsg(UID, 2, 310, 3037, NPC, 3002, 224);
end
...
if (EVENT == 226) then
	SaveEvent(UID, 3095);
	SelectMsg(UID, 2, 310, 3045, NPC, 32, 193);
end

if (EVENT == 228) then
	ITEM_COUNT = HowmuchItem(UID, 900017000);
	if (ITEM_COUNT > 6) then
		SelectMsg(UID, 4, 310, 3043, NPC, 41, 230, 27, 193);
	else
...
if (EVENT == 230) then
	...
	SaveEvent(UID, 3094);
	SelectMsg(UID, 2, 310, 3044, NPC, 10, 193);
end

if (EVENT == 300) then
	SelectMsg(UID, 2, 327, 3001, NPC, 28, 301);
end
...
if (EVENT == 302) then
	SelectMsg(UID, 2, 327, 3002, NPC, 28, 301);
end
...
if (EVENT == 306) then
	SaveEvent(UID, 3115);
	SelectMsg(UID, 2, 327, 3054, NPC, 3009, 193);
end
...
if (EVENT == 308) then
	...
	if (ITEM_COUNTA > 4 and ITEM_COUNTB > 0 and ITEM_COUNTC > 1) then
		SelectMsg(UID, 4, 327, 3055, NPC, 41, 310, 27, 193);
	else
...
if (EVENT == 400) then
	SelectMsg(UID, 2, 327, 3001, NPC, 28, 401);
end
...
if (EVENT == 402) then
	SelectMsg(UID, 2, 327, 3002, NPC, 28, 401);
end

if (EVENT == 403) then -- 69 Level Stamp of Intelligence
	SelectMsg(UID, 2, 327, 3056, NPC, 10, 404);
end

if (EVENT == 404) then
	SelectMsg(UID, 4, 327, 3057, NPC, 22, 405, 23, 193);
end
...
if (EVENT == 406) then
	SaveEvent(UID, 3135);
	SelectMsg(UID, 2, 327, 3062, NPC, 3006, 193);
end
...
if (EVENT == 408) then
	...
	if (ITEM_COUNTA > 0 and ITEM_COUNTB  > 0 and ITEM_COUNTC > 0) then
		SelectMsg(UID, 4, 327, 3063, NPC, 41, 410, 27, 193);
	else
		if (ITEM_COUNTA < 1) then
			SelectMsg(UID, 2, 327, 3060, NPC, 18, 409);
		elseif (ITEM_COUNTB < 1) then
			SelectMsg(UID, 2, 327, 3060, NPC, 18, 411);
		elseif (ITEM_COUNTC < 1) then
			SelectMsg(UID, 2, 327, 3060, NPC, 18, 412);
		end
	end
end
...
if (EVENT == 620) then
	SelectMsg(UID, 2, 337, 3245, NPC, 3006, 621);
end
...
if (EVENT == 622) then
	SelectMsg(UID, 2, 337, 3244, NPC, 3006, 621);
end
...
if (EVENT == 626) then
	SaveEvent(UID, 3475);
	SelectMsg(UID, 2, 337, 3252, NPC, 32, 193);
end
...
if (EVENT == 628) then
	...
	if (ITEM_COUNT1 > 0 and ITEM_COUNT2 > 0 and ITEM_COUNT3 > 6999999) then
		...
		if (ITEM_COUNTA < 1 or ITEM_COUNTB < 1) then
			SelectMsg(UID, 2, 337, 3250, NPC, 18, 629);
