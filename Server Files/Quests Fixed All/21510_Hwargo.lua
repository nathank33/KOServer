...
if (EVENT == 201) then
	SelectMsg(UID, 4, 177, 1174, NPC, 22, 202, 23, 193);
end
...
if (EVENT == 205) then
	SelectMsg(UID, 2, 177, 1175, NPC, 10, 193);
	SaveEvent(UID, 470);
end
...
if (EVENT == 210) then
	...
	elseif (ITEMA > 2 and ITEMB > 0) then
		SelectMsg(UID, 4, 177, 1179, NPC, 41, 214, 27, 193);
	end
end
...
if (EVENT == 532) then -- 50 Level 7 Keys Quest
	SelectMsg(UID, 4, 618, 4196, NPC, 22, 533, 23, 534);
end
...
if (EVENT == 536) then
	...
	if (ITEM7 > 0) then
		SelectMsg(UID, 4, 618, 4197, NPC, 4172, 537, 4173, 193);
	else
		SelectMsg(UID, 2, 618, 4198, NPC, 18, 192);
	end
end
...
if (EVENT == 1001) then
	SelectMsg(UID, 4, 438, 9238, NPC, 22, 1002, 23, 1003);
end
...
if (EVENT == 1007) then
	...
	if (ITEMBDW < 1) then
		SelectMsg(UID, 2, 438, 9238, NPC, 18, 191);
	else
		SelectMsg(UID, 4, 438, 9238, NPC, 4006, 1008, 4005, 193);
	end
end
