...
if (EVENT == 700) then -- 45 Level Cardinal Jewel
	SelectMsg(UID, 2, 786, 3001, NPC, 28, 701);
end
...
if (EVENT == 702) then
	SelectMsg(UID, 2, 786, 3002, NPC, 28, 701);
end

if (EVENT == 703) then
	SelectMsg(UID, 2, 786, 3131, NPC, 10, 704);
end

if (EVENT == 704) then
	SelectMsg(UID, 4, 786, 3132, NPC, 22, 705, 23, 193);
end
...
if (EVENT == 706) then
	...
	if (NATION == 1) then
		SelectMsg(UID, 2, 786, 3136, NPC, 3015, 193);
	else
		SelectMsg(UID, 2, 786, 3006, NPC, 3015, 193);
	end
end
...
if (EVENT == 708) then
	...
	if (ITEM_COUNT == 0) then
		SelectMsg(UID, 2, 786, 3135, NPC, 18, 709);
	else
		SelectMsg(UID, 4, 786, 3137, NPC, 41, 710, 27, 193);
	end
end
