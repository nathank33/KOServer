...
if (EVENT == 1000) then
  SelectMsg(UID, 2, 73, 1549, NPC, 10, 101);
end
...
-- Repurchase Item
if (EVENT == 502) then
  SelectMsg(UID, 2, 73, 10745, NPC, 22, 171, 23, 101);
end
...
if (EVENT == 800) then
  SelectMsg(UID, 2, 73, 1546, NPC, 7012, 801, 7013, 805);
end
...
LEADER = isClanLeader(UID)
	SelectMsg(UID, 2, 73, 1537, NPC, 10, 101);
end

if (EVENT == 900) then
	SelectMsg(UID, 2, 73, 1522, NPC, 7014, 901, 73, 903);
end

if (EVENT == 901) then
	SelectMsg(UID, 2, 73, 1532, NPC, 10, 902);
end
...
if (EVENT == 600) then
	SelectMsg(UID, 2, 73, 11640, NPC, 7014, 601, 73, 101);
end

if (EVENT == 601) then
	SelectMsg(UID, 2, 73, 11641, NPC, 10, 602);
end
...
if (EVENT == 300) then
	SelectMsg(UID, 2, 73, 44294, NPC, 4160, 301);
end

if (EVENT == 301) then
	SelectMsg(UID, 2, 73, 44295, NPC, 4161, 302, 4162, 101);
end

if (EVENT == 302) then
-- Premium Checks has the req premium no money else rob money 100m
SelectMsg(UID, 2, 73, 44296, NPC, 27, 101);
end