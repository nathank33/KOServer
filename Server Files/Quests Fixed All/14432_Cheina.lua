...
if (EVENT == 8756) then
	MonsterCount = CountMonsterQuestSub(UID, 397, 1);
...
if (EVENT == 8172) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 266, 8394, NPC, 10, 8175);
	else
		SelectMsg(UID, 2, 266, 8282, NPC, 10, 163);
	end
end

if (EVENT == 8175) then
	SelectMsg(UID, 4, 266, 8395, NPC, 22, 8173, 23, 163);
end
...
if (EVENT == 8181) then
	SelectMsg(UID, 2, 266, 8393, NPC, 3007, 163);
end

if (EVENT == 8176) then
	MonsterCount = CountMonsterQuestSub(UID, 859, 1);
	if (MonsterCount < 10) then
		SelectMsg(UID, 2, 266, 8394, NPC, 18, 8177);
	else
		SelectMsg(UID, 4, 266, 8396, NPC, 41, 8178, 27, 163);
	end
end
...
if (EVENT == 9430) then -- 47 Level Macairodus
	SelectMsg(UID, 2, 476, 8761, NPC, 10, 9431);
end
...
if (EVENT == 9432) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 476, 8761, NPC, 22, 9433, 23, 9434);
	else
		SelectMsg(UID, 2, 476, 8761, NPC, 10, 163);
	end
end
...
if (EVENT == 9441) then
	SelectMsg(UID, 2, 476, 8759, NPC, 3007, 163);
end

if (EVENT == 9436) then
	MonsterCount = CountMonsterQuestSub(UID, 911, 1);
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 476, 8384, NPC, 18, 9437);
	else
		SelectMsg(UID, 4, 476, 8396, NPC, 41, 9438, 27, 163);
	end
end
...
if (EVENT == 9450) then -- 51 Level Blood Don
	SelectMsg(UID, 2, 268, 8763, NPC, 10, 9451);
end
...
if (EVENT == 9452) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 268, 8763, NPC, 22, 9453, 23, 163);
	else
		SelectMsg(UID, 2, 268, 8763, NPC, 10, 163);
	end
end
...
if (EVENT == 9456) then
	...
	if (MonsterCount < 20) then
		SelectMsg(UID, 2, 268, 8384, NPC, 18, 9457);
	else
		SelectMsg(UID, 4, 268, 8396, NPC, 41, 9458, 27, 163);
	end
end
...
if (EVENT == 9060) then -- 56 Level Grell
	SelectMsg(UID, 2, 479, 8228, NPC, 3003, 9061);
end
...
if (EVENT == 9062) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 479, 8426, NPC, 10, 9070);
	else
		SelectMsg(UID, 2, 479, 8428, NPC, 10, 163);
	end
end

if (EVENT == 9070) then
	SelectMsg(UID, 4, 479, 8427, NPC, 22, 9063, 23, 9064);
end
...
if (EVENT == 9065) then
	SelectMsg(UID, 2, 479, 8429, NPC, 3014, 163);
	SaveEvent(UID, 9126);
end
...
if (EVENT == 9067) then
	...
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 479, 8430, NPC, 18, 9068);
	else
		SelectMsg(UID, 4, 479, 8431, NPC, 41, 9069, 27, 163);
	end
end
...
if (EVENT == 9320) then -- 57 Level Hell Hound
	SelectMsg(UID, 2, 270, 8677, NPC, 10, 9321);
end
...
if (EVENT == 9322) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 270, 8677, NPC, 22, 9323, 23, 9324);
	else
		SelectMsg(UID, 2, 270, 8677, NPC, 10, 163);
	end
end
...
if (EVENT == 9327) then
	...
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 270, 8552, NPC, 18, 9328);
	else
		SelectMsg(UID, 4, 270, 8431, NPC, 41, 9329, 27, 163);
	end
end
...
if (EVENT == 9340) then -- 59 Level Manticore
	SelectMsg(UID, 2, 482, 8681, NPC, 10, 9341);
end
...
if (EVENT == 9342) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 482, 8681, NPC, 22, 9343, 23, 9344);
	else
		SelectMsg(UID, 2, 482, 8681, NPC, 10, 163);
	end
end
...
if (EVENT == 9347) then
	...
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 482, 8566, NPC, 18, 9348);
	else
		SelectMsg(UID, 4, 482, 8431, NPC, 41, 9349, 27, 163);
	end
end
