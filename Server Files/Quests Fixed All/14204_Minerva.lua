...
if (EVENT == 210) then
	...
	if (ITEM_COUNT < 1) then
		SelectMsg(UID, 2, 273, 3019, NPC, 18, 213);
	else
		SelectMsg(UID, 4, 273, 3022, NPC, 41, 214, 27, 213);
	end
end
...
if (EVENT == 400) then
	SelectMsg(UID, 2, 328, 3001, NPC, 28, 401);
end
...
if (EVENT == 402) then
	SelectMsg(UID, 2, 328, 3002, NPC, 28, 401);
end
...
if (EVENT == 406) then
	SaveEvent(UID, 3125);
	SelectMsg(UID, 2, 328, 3062, NPC, 3006, 193);
end
...
if (EVENT == 408) then
	...
	if (ITEM_COUNTA > 0 and ITEM_COUNTB > 0 and ITEM_COUNTC > 0) then
		SelectMsg(UID, 4, 328, 3063, NPC, 41, 410, 27, 193);
	else
