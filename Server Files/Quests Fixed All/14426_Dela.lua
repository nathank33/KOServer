...
if (EVENT == 325) then
	MonsterCount = CountMonsterQuestSub(UID, 356, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 315) then
	...
	MonsterCount2 = CountMonsterQuestSub(UID, 356, 1);
	MonsterCount3 = CountMonsterQuestSub(UID, 356, 1);
...
if (EVENT == 307) then
	MonsterCount1 = CountMonsterQuestSub(UID, 444, 1);
	MonsterCount2 = CountMonsterQuestSub(UID, 444, 2);
