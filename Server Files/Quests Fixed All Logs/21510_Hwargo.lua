...
new_line: 	SelectMsg(UID, 4, 618, 4196, NPC, 22, 533, 23, 534);
9 still in 	SelectMsg(UID, 4, 618, 4196, NPC, 22, 533, 23, 534);
...
new_line: 		SelectMsg(UID, 4, 618, 4197, NPC, 4172, 537, 4173, 193);
9 still in 		SelectMsg(UID, 4, 618, 4197, NPC, 4172, 537, 4173, 193);
8 still in 		SelectMsg(UID, 2, 9, 4198, NPC, 18, 192);
new_line: 		SelectMsg(UID, 2, 618, 4198, NPC, 18, 192);
9 still in 		SelectMsg(UID, 2, 618, 4198, NPC, 18, 192);
...
new_line: 	SelectMsg(UID, 4, 438, 9238, NPC, 22, 1002, 23, 1003);
