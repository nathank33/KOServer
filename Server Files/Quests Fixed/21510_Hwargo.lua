...
if (EVENT == 532) then -- 50 Level 7 Keys Quest
	SelectMsg(UID, 4, 220, 4196, NPC, 22, 533, 23, 534);
end
...
if (EVENT == 536) then
	...
	if (ITEM7 > 0) then
		SelectMsg(UID, 4, 220, 4197, NPC, 4172, 537, 4173, 193);
	else
...
if (EVENT == 1001) then
	SelectMsg(UID, 4, 494, 9238, NPC, 22, 1002, 23, 1003);
end
...
if (EVENT == 1007) then
	...
	if (ITEMBDW < 1) then
		...
		SelectMsg(UID, 4, 494, 9238, NPC, 4006, 1008, 4005, 193);
	end
end
