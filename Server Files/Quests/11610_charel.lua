...
if (EVENT == 124) then
	SelectMsg(UID, 2, 19, 6438, NPC, 4161, 126, 4162, 241);
end
...
if (EVENT == 286) then
	SelectMsg(UID, 2, 21, 4272, NPC, 4161, 287, 4162, 241);
end
...
if (EVENT == 361) then 
	...
	if (ITEM_COUNT < 1500000) then
		...
		SelectMsg(UID, 4, 22, 4258, NPC, 22, 362, 23, 241);
	end
end
...
if (EVENT == 363) then
	...
	if (ITEM_COUNT < 350000) then
		...
		SelectMsg(UID, 4, 23, 4259, NPC, 22, 364, 23, 241);
	end
end
