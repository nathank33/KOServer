...
if (EVENT == 1000) then -- 47 Level Hornet Premium
	SelectMsg(UID, 2, 203, 8157, NPC, 3003, 1001);
end
...
if (EVENT == 1002) then
	...
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 203, 8157, NPC, 10, 1010);
	else
...
if (EVENT == 1010) then
	SelectMsg(UID, 4, 203, 8236, NPC, 22, 1003, 23, 1004);
end
...
if (EVENT == 1007) then
	...
	if (MonsterCount < 20) then
		SelectMsg(UID, 2, 203, 8417, NPC, 18, 1008);
	else
		SelectMsg(UID, 4, 203, 8237, NPC, 10, 1009, 27, 193);
	end
end
...
if (EVENT == 8050) then -- 47 Level Hornet
	SelectMsg(UID, 2, 427, 8234, NPC, 3003, 8051);
end
...
if (EVENT == 8052) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 427, 8235, NPC, 10, 8060);
	else
...
if (EVENT == 8060) then
	SelectMsg(UID, 4, 427, 8236, NPC, 22, 8053, 23, 8054);
end
...
if (EVENT == 8057) then
	...
	if (MonsterCount < 30) then
		SelectMsg(UID, 2, 427, 8417, NPC, 18, 8058);
	else
		SelectMsg(UID, 4, 427, 8237, NPC, 41, 8059, 27, 193);
	end
end
...
if (EVENT == 9515) then
	SelectMsg(UID, 4, 210, 8768, NPC, 22, 9513, 23, 9514);
end
...
if (EVENT == 9520) then
	SelectMsg(UID, 2, 210, 8416, NPC, 3007, 193);
	SaveEvent(UID, 9642);
end
...
if (EVENT == 9516) then
	...
	if (MonsterCount < 40) then
		...
		SelectMsg(UID, 4, 210, 8237, NPC, 41, 9518, 27, 193);
	end
end
...
if (EVENT == 200) then -- 52 Level Haunga Warrior Premium
	SelectMsg(UID, 2, 225, 8165, NPC, 3003, 201);
end
...
if (EVENT == 202) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 225, 8158, NPC, 10, 210);
	else
...
if (EVENT == 210) then
	SelectMsg(UID, 4, 225, 8236, NPC, 22, 203, 23, 204);
end
...
if (EVENT == 205) then
	SelectMsg(UID, 2, 225, 8416, NPC, 3007, 193);
	SaveEvent(UID, 2220);
end
...
if (EVENT == 207) then
	...
	if (MonsterCount < 20) then
		SelectMsg(UID, 2, 225, 8417, NPC, 18, 208);
	else
		SelectMsg(UID, 4, 225, 8237, NPC, 41, 209, 27, 193);
	end
end
...
if (EVENT == 8450) then -- 52 Level Haunga Warrior
	SelectMsg(UID, 2, 461, 8238, NPC, 3003, 8451);
end
...
if (EVENT == 8452) then
	...
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 461, 8239, NPC, 10, 8460);
	else
...
if (EVENT == 8460) then
	SelectMsg(UID, 4, 461, 8240, NPC, 22, 8453, 23, 8454);
end
...
if (EVENT == 8455) then
	SelectMsg(UID, 2, 461, 8416, NPC, 3014, 193);
	SaveEvent(UID, 9036);
end
...
if (EVENT == 8457) then
	...
	if (MonsterCount < 20) then
		SelectMsg(UID, 2, 461, 8417, NPC, 18, 8458);
	else
		SelectMsg(UID, 4, 461, 8241, NPC, 41, 8459, 27, 193);
	end
end
...
if (EVENT == 300) then -- 57 Level Phantom Premium
	SelectMsg(UID, 2, 447, 8678, NPC, 3003, 301);
end
...
if (EVENT == 302) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 447, 8157, NPC, 10, 310);
	else
...
if (EVENT == 310) then
	SelectMsg(UID, 4, 447, 8236, NPC, 22, 303, 23, 304);
end
...
if (EVENT == 305) then
	SelectMsg(UID, 2, 447, 8416, NPC, 3007, 193);
	SaveEvent(UID, 2316);
end
...
if (EVENT == 307) then
	...
	if (MonsterCount < 20) then
		SelectMsg(UID, 2, 447, 8417, NPC, 18, 308);
	else
		SelectMsg(UID, 4, 447, 8237, NPC, 41, 309, 27, 193);
	end
end
...
if (EVENT == 400) then -- 58 Level Groom Hound Premium
	SelectMsg(UID, 2, 477, 8682, NPC, 3003, 401);
end
...
if (EVENT == 402) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 477, 8157, NPC, 10, 410);
	else
...
if (EVENT == 410) then
	SelectMsg(UID, 4, 477, 8236, NPC, 22, 403, 23, 404);
end
...
if (EVENT == 407) then
	...
	if (MonsterCount < 20) then
		SelectMsg(UID, 2, 477, 8417, NPC, 18, 408);
	else
		SelectMsg(UID, 4, 477, 8237, NPC, 41, 409, 27, 193);
	end
end
...
if (EVENT == 9330) then -- 57 Level Phantom
	SelectMsg(UID, 2, 272, 8234, NPC, 3003, 9331);
end
...
if (EVENT == 9332) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 272, 8678, NPC, 10, 9340);
	else
...
if (EVENT == 9340) then
	SelectMsg(UID, 4, 272, 8678, NPC, 22, 9333, 23, 9334);
end
...
if (EVENT == 9337) then
	...
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 272, 8575, NPC, 10, 9338);
	else
		SelectMsg(UID, 4, 272, 8581, NPC, 41, 9339, 27, 193);
	end
end
...
if (EVENT == 9352) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 2, 480, 8682, NPC, 10, 9360);
	else
...
if (EVENT == 9360) then
	SelectMsg(UID, 4, 480, 8236, NPC, 22, 9353, 23, 9354);
end
...
if (EVENT == 9355) then
	SaveEvent(UID, 9378);
	SelectMsg(UID, 2, 480, 8416, NPC, 3014, 193);
end

if (EVENT == 9357) then
	MonsterCount = CountMonsterQuestSub(UID, 3571, 1);
	if (MonsterCount < 40) then
		SelectMsg(UID, 2, 480, 8557, NPC, 18, 9358);
	else
		SelectMsg(UID, 4, 480, 8569, NPC, 41, 9359, 27, 193);
	end
end
