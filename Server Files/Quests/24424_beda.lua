...
if (EVENT == 9392) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1013, 8690, NPC, 22, 9393, 23, 9394);
	else
		SelectMsg(UID, 2, 1013, 8690, NPC, 10, 193);
	end
end
...
if (EVENT == 9397) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1013, 8690, NPC, 18, 9398);
	else
		SelectMsg(UID, 4, 1013, 8690, NPC, 41, 9399, 27, 9398);
	end
end
...
if (EVENT == 9422) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1017, 8696, NPC, 22, 9423, 23, 9424);
	else
		SelectMsg(UID, 2, 1017, 8696, NPC, 10, 193);
	end
end
...
if (EVENT == 9427) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1017, 8696, NPC, 18, 9428);
	else
		SelectMsg(UID, 4, 1017, 8696, NPC, 41, 9429, 27, 9428);
	end
end
