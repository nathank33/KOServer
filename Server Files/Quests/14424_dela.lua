...
if (EVENT == 9542) then
	...
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 351, 8773, NPC, 22, 9543, 23, 9544);
	else
		SelectMsg(UID, 2, 351, 8773, NPC, 10, 193);
	end
end
...
if (EVENT == 9547) then
	...
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 351, 8773, NPC, 18, 9548);
	else
		SelectMsg(UID, 4, 351, 8773, NPC, 41, 9549, 27, 9548);
	end
end
...
if (EVENT == 9372) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 1097, 8687, NPC, 22, 9373, 23, 9374);
	else
		SelectMsg(UID, 2, 1097, 8687, NPC, 10, 193);
	end
end
...
if (EVENT == 9377) then
	MonsterCount = CountMonsterQuestSub(UID, 1097, 1);
	if (MonsterCount < 250) then
		SelectMsg(UID, 2, 1097, 8687, NPC, 18, 9378);
	else
		SelectMsg(UID, 4, 1097, 8687, NPC, 41, 9379, 27, 9378);
	end
end
