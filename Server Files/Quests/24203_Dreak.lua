...
if (EVENT == 383) then -- 53 Level Spell of Thorn
	SelectMsg(UID, 2, 236, 520, NPC, 28, 384);
end
...
if (EVENT == 385) then
	SelectMsg(UID, 2, 236, 521, NPC, 10, 386);
end

if (EVENT == 386) then
	SelectMsg(UID, 2, 236, 522, NPC, 22, 387, 23, 193);
end
...
if (EVENT == 388) then
	SaveEvent(UID, 582);
	SelectMsg(UID, 2, 236, 524, NPC, 21, 193);
end
...
if (EVENT == 390) then
	...
	if (ITEM_COUNT1 < 1000000) then
		SelectMsg(UID, 2, 236, 525, NPC, 18, 393);
	end
	if (ITEM_COUNT2 < 3) then
		SelectMsg(UID, 2, 236, 526, NPC, 18, 392);
	end
	if (ITEM_COUNT1 > 999999 and ITEM_COUNT2 > 2) then
		SelectMsg(UID, 2, 236, 528, NPC, 41, 394, 27, 193);
	end
end
