...
if (EVENT == 3002) then -- 12 Level Orc Duel
	SelectMsg(UID, 2, 84, 1188, NPC, 28, 3003);
end
...
if (EVENT == 3004) then
	SelectMsg(UID, 2, 84, 1189, NPC, 10, 3003);
end

if (EVENT == 3005) then
	SelectMsg(UID, 2, 84, 1190, NPC, 10, 3006);
end

if (EVENT == 3006) then
	SelectMsg(UID, 4, 84, 1191, NPC, 22, 3007, 23, 3001);
end
...
if (EVENT == 3008) then
	...
	if (NATION == 1) then
		SelectMsg(UID, 2, 84, 1192, NPC, 32, 3009);
	else
		SelectMsg(UID, 2, 84, 1193, NPC, 21, 3009);
	end
end
...
if (EVENT == 3010) then
	...
	if (ITEM_COUNT < 5) then
		SelectMsg(UID, 2, 84, 1194, NPC, 18, 3011);
	else
		SelectMsg(UID, 4, 84, 1195, NPC, 4006, 3012, 4005, 3001);
	end
end
...
if (EVENT == 6060) then -- 21 Level Gem of Bravery
	SelectMsg(UID, 2, 88, 6014, NPC, 28, 6061);
end
...
if (EVENT == 6062) then
	SelectMsg(UID, 2, 88, 6015, NPC, 10, 6061);
end
...
if (EVENT == 6064) then
	SelectMsg(UID, 4, 88, 6017, NPC, 22, 6065, 23, 3001);
end
...
if (EVENT == 6066) then
	...
	NATION = CheckNation(UID);
	if (NATION == 1) then
		SelectMsg(UID, 2, 88, 6019, NPC, 32, 6067);
	else
		SelectMsg(UID, 2, 88, 6020, NPC, 21, 6067);
	end
end
...
if (EVENT == 6068) then
	...
	if (ITEM_COUNT < 10) then
		...
		SelectMsg(UID, 4, 88, 6022, NPC, 4006, 6070, 4005, 3001);
	end
end
...
if (EVENT == 6080) then -- 40 Level Goblin
	SelectMsg(UID, 2, 437, 6030, NPC, 28, 6061);
end
...
if (EVENT == 6082) then
	SelectMsg(UID, 2, 437, 6031, NPC, 10, 6081);
end

if (EVENT == 6083) then
	SelectMsg(UID, 2, 437, 6032, NPC, 10, 6084);
end

if (EVENT == 6084) then
	Level = CheckLevel(UID)
	if (Level > 1 and Level < 39) then  
		SelectMsg(UID, 2, 437, 6033, NPC, 10, 3001);
	elseif (Level == 40) then
		SelectMsg(UID, 2, 437, 6034, NPC, 59, 6085, 60, 3001);
	else
		SelectMsg(UID, 2, 437, 6035, NPC, 10, 3001);
	end
end
...
if (EVENT == 6086) then
	...
	if (Level == 41) then
		...
		NATION = CheckNation(UID);
		if (NATION == 1) then
			SelectMsg(UID, 2, 437, 6036, NPC, 61, 3001);
		else
			SelectMsg(UID, 2, 437, 6037, NPC, 62, 3001);
		end
	end
end
