...
public:
	...
	void Type4Duration();
	INLINE bool isLockableScroll(uint8 buffType) { return (buffType == BUFF_TYPE_HP_MP || buffType == BUFF_TYPE_AC || buffType == BUFF_TYPE_STATS || buffType == BUFF_TYPE_DAMAGE || buffType == BUFF_TYPE_FISHING || buffType == BUFF_TYPE_BATTLE_CRY); }
